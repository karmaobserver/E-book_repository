...
public class ResultRetriever {
	 ...
	 * @throws IllegalArgumentException ako se u direktorijumu ne nalaze indeksi ili je direktorijum zakljucan
	 */
	public static List<Document> getResults(Query query, Sort sort){
		String path = ResourceBundle.getBundle("index").getString("index");
		File indexDirPath = new File(path);
		return getResults(query, indexDirPath, false, sort);
	}
	 ...
	 * @throws IllegalArgumentException ako se u direktorijumu ne nalaze indeksi ili je direktorijum zakljucan
	 */
	public static List<Document> getResults(Query query, File indexDirPath, boolean analyzeQuery){
		return getResults(query, indexDirPath, analyzeQuery, null);
	}
	 ...
	 * @throws IllegalArgumentException ako se u direktorijumu ne nalaze indeksi ili je direktorijum zakljucan
	 */
	public static List<Document> getResults(Query query, File indexDirPath, Sort sort){
		return getResults(query, indexDirPath, false, sort);
	}
	 ...
	 * @throws ParseException ako upit nije moguce parsirati
	 */
	public static List<Document> getResults(Query query, boolean analyzeQuery, Sort sort){
		String path = ResourceBundle.getBundle("index").getString("index");
		File indexDirPath = new File(path);
		return getResults(query, indexDirPath, analyzeQuery, sort);
	}
	 ...
	 * @throws ParseException ako upit nije moguce parsirati
	 */
	public static List<Document> getResults(Query query, File indexDirPath, boolean analyzeQuery, Sort sort){
		if(query == null){
			return null;
		}
		try {
			...
			ScoreDoc[] scoreDocs = is.search(query, maxHits, sort).scoreDocs;
